...
# 描画の設定
fig, (ax1, ax2, ax3, ax4) = plt.subplots(4, 1, gridspec_kw={"height_ratios": [1, 1, 2, 1]})
...
def _update(frame):
    ...
    if status == 0:
        ...
        ax3.text(4.5, 2, "在席", color="#999999", fontsize="36", bbox=boxdic_other)
        ax3.text(7.5, 2, "一時離席", color="#999999", fontsize="36", bbox=boxdic_other)

    if status == 1:
        ax3.text(1.5, 2, "不在", color="#999999", fontsize="36", bbox=boxdic_other)
        ax3.text(
            4.5,
            2,
            "在席",
    ...
    if status == 2:
        ...
        ax3.text(7.5, 2, "一時離席", color="green", fontsize="36", bbox=boxdic_leaving)
